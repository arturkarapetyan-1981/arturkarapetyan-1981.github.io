...
const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: "Template",
    images: [
      "/templates/temp-1.png",
      "/templates/temp-1-1.png",
      "/templates/temp-1-2.png",
      "/templates/temp-1-3.png",
      "/templates/temp-1-4.png",
      "/templates/temp-1-5.png",
      "/templates/temp-1-6.png",
    ],
  ...
  },
  {
    ...
    category: "Template",
    images: [
      "/templates/temp-2.png",
      "/templates/temp-2-1.png",
      "/templates/temp-2-2.png",
      "/templates/temp-2-3.png",
    ],
  ...
  },
  {
    ...
    category: "Template",
    images: [
      "/templates/temp-3.png",
      "/templates/temp-3-1.png",
      "/templates/temp-3-2.png",
    ],
  ...
  },
  {
    ...
    category: "Template",
    images: [
      "/templates/temp-4.png",
      "/templates/temp-4-1.png",
      "/templates/temp-4-2.png",
      "/templates/temp-4-3.png",
    ],
  ...
  },
  {
    ...
    category: "Template",
    images: [
      "/templates/temp-5.png",
      "/templates/temp-5-1.png",
      "/templates/temp-5-2.png",
      "/templates/temp-5-3.png",
      "/templates/temp-5-4.png",
      "/templates/temp-5-5.png",
    ],
  ...
  },
  {
    ...
    category: "Template",
    images: [
      "/templates/temp-6.png",
      "/templates/temp-6-1.png",
      "/templates/temp-6-2.png",
      "/templates/temp-6-3.png",
      "/templates/temp-6-4.png",
    ],
  ...
  },
  {
    ...
    category: "Template",
    images: [
      "/templates/temp-7.png",
      "/templates/temp-7-1.png",
      "/templates/temp-7-2.png",
      "/templates/temp-7-3.png",
      "/templates/temp-7-4.png",
    ],
...
export default function Portfolio() {
  ...
  const [activeCard, setActiveCard] = useState<number | null>(null); // touch/keyboard reveal
      ...
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {visibleItems.map((item) => {
            const isHover = hoveredCard === item.id;
            const isActive = activeCard === item.id || isHover;
            ...
            return (
              <div
                ...
                // Prevent immediate navigation on first tap; first tap reveals overlay
                onClickCapture={(e) => {
                  if (!isActive) {
                    e.preventDefault();
              ...
              >
                ...
                {/* Full-card link (behind overlay buttons) */}
                <Link
                  href={item.link}
                  target="_blank"
                ...
                <div
                  className={[
                    ...
                    // hidden by default; visible on hover (desktop) or when active (touch/keyboard)
                ...
                >
                  ...
                  <button
                    onClick={(e) => onPlusClick(e, item.images, 0)}
